...
messi_row = pd.DataFrame({
    ...
    "Standard_SoT/90": [2.42], "Take-Ons_Succ_per90": [4.33],"Take-Ons_Succ%":[62.9],"Take-Ons_Tkld%":[35.5], "Touches_Att Pen_per90": [5.89],"Touches_Att 3rd_per90": [41],
...
# --- Save ---
df_result.to_csv("results_per90/messi_similarity__all_scores_updated_with_per90.csv", index=False, encoding='utf-8-sig')
cosine_result.to_csv("results_per90/messi_similarity_cosine_scores_updated.csv", index=False, encoding='utf-8-sig')
autoencoder_result.to_csv("results_per90/messi_similarity_autoencoder_scores_updated.csv", index=False, encoding='utf-8-sig')
